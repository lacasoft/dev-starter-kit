...
Toma siempre la última versión de `main` (o el tag indicado). Repo **privado**: funciona con tu auth de `git`/`gh`.
...
Repo **privado** distribuido por `npx github:` → la rama **`main` debe estar siempre verde**.
